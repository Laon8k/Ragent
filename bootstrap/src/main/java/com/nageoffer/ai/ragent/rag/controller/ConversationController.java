...
import com.nageoffer.ai.ragent.rag.service.MemoryCompressionService;
...
public class ConversationController {
     ...
     * 上下文压缩效果对比
     * <p>
     * 返回同一会话「有摘要」vs「无摘要」时 LLM 实际看到的上下文，
     * 用于直观验证上下文压缩功能的效果。
     */
    @GetMapping("/conversations/{conversationId}/memory-context")
    public Result<MemoryContextVO> memoryContext(@PathVariable String conversationId) {
        return Results.success(memoryCompressionService.compare(conversationId, UserContext.getUserId()));
    }
}
