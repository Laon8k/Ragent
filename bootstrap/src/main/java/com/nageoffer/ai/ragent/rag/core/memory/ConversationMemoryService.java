...
public interface ConversationMemoryService {
    ...
    /**
     * 使用外部预生成的 ID 追加消息（用于需要 SSE 与 DB 使用同一 messageId 的场景）
     *
     * @param conversationId 对话ID
     * @param userId         用户ID
     * @param message        要追加的消息
     * @param messageId      外部预生成的消息ID
     */
    void appendWithId(String conversationId, String userId, ChatMessage message, String messageId);
