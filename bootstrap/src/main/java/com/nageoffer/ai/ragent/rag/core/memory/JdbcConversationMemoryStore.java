...
public class JdbcConversationMemoryStore implements ConversationMemoryStore {
    ...
    public String append(String conversationId, String userId, ChatMessage message) {
        ConversationMessageBO conversationMessage = buildMessageBO(conversationId, userId, message, null);
        String messageId = conversationMessageService.addMessage(conversationMessage);
        syncConversationIfUser(conversationId, userId, message);
        return messageId;
    }

    @Override
    public void appendWithId(String conversationId, String userId, ChatMessage message, String messageId) {
        ConversationMessageBO conversationMessage = buildMessageBO(conversationId, userId, message, messageId);
        conversationMessageService.addMessage(conversationMessage);
        syncConversationIfUser(conversationId, userId, message);
    }

    private ConversationMessageBO buildMessageBO(String conversationId, String userId,
                                                 ChatMessage message, String messageId) {
        return ConversationMessageBO.builder()
                .id(messageId)
    ...
    private void syncConversationIfUser(String conversationId, String userId, ChatMessage message) {
